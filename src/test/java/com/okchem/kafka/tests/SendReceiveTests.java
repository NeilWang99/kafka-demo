package com.okchem.kafka.tests;
...
public class SendReceiveTests {
    private Logger logger = LoggerFactory.getLogger(SendReceiveTests.class);
    ...
    private Map<String, Object> consumerProps() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.1.14:9092");
